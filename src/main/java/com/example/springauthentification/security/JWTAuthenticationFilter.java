package com.example.springauthentification.security;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
  ...
  public Authentication attemptAuthentication(
    ...
    try {
    	...
    	com.example.springauthentification.Entities.User loginUser =
          new ObjectMapper()
              .readValue(request.getInputStream(), com.example.springauthentification.Entities.User.class);
